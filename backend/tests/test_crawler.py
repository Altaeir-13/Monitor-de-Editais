...
try:
    ...
    results["20_endpoint_requires_token"] = no_token_response.status_code == 401
    results["21_endpoint_requires_admin"] = common_response.status_code == 403
    results["22_endpoint_returns_summary"] = admin_response.status_code == 200 and admin_response.json() == fake_summary
